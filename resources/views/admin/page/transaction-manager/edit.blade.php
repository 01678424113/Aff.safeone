                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-form ">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('transaction-manager.update',['id'=>$model->id]) }}" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <select name="type" id="" class="form-control select2">
                                                <option {{($model->status == \App\Models\Transaction::$TYPE_PLUS) ? 'selected' : ''}} value="{{\App\Models\Transaction::$TYPE_PLUS}}">Cộng
                                                    tiền
                                                </option>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Trang thái</label>
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <textarea class="resizable_textarea form-control" rows="5"
                                                                  required id="" name="note" placeholder="">{{$model->note}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn green">Lưu giao dịch</button>
